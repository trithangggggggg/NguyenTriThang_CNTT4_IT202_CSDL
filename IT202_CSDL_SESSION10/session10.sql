...
-- 4
delete from users where username = 'nguyenlong';
select * from view_users_firstname;
...
drop index if exists idx_hometown on users;
...
drop index if exists idx_created_at_user_id on posts;
...
drop index if exists idx_user_gender on users;
